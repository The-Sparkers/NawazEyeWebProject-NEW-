...
namespace NawazEyeWebProject_NEW_.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            {
                HandleErrorInfo error = new HandleErrorInfo(ex, "Account", "Register");
                return RedirectToAction("Index", "Error", new { model = error });
            }
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        Buyer b = new Buyer(model.FullName, model.PhoneNumber, model.Address, model.Email, c);
                        b.SetAccount(user.Id);
    ...
    public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
    {
            ...
            {
                HandleErrorInfo error = new HandleErrorInfo(ex, "Account", "ExternalLoginCallback");
                return RedirectToAction("Index", "Error", new { model = error });
            }
        }
    ...
    public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
    {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        City c = new City(Convert.ToInt32(model.City));
                        Buyer b = new Buyer(model.FullName, model.PhoneNumber, model.Address, model.Email, c);
                        b.SetAccount(user.Id);
                        if (result.Succeeded)
                        {
            ...
            {
                HandleErrorInfo error = new HandleErrorInfo(ex, "Account", "ExternalLoginConfirmation");
                return RedirectToAction("Index", "Error", new { model = error });
            }
        }
    ...
    public ActionResult ExternalLoginFailure()
    {
            ...
            {
                HandleErrorInfo error = new HandleErrorInfo(ex, "Account", "ExternalLoginFailure");
                return RedirectToAction("Index", "Error", new { model = error });
            }
        }
